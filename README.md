...
3. Enable **Snippet Commands** under Settings → Community plugins.

**Manual:**

1. Download `manifest.json` and `main.js` from the latest release (or build from source).
2. Copy them into `<vault>/.obsidian/plugins/snippet-commands/`.
3. Enable **Snippet Commands** under Settings → Community plugins.

## Usage

1. Open the command palette (`Cmd/Ctrl + P`).
2. Run `Snippet Commands: Toggle snippet…` and pick a snippet — or run `Toggle snippet: <name>` directly.
